...
const features = [
  {
    ...
    description: "Create, schedule, pause, and monitor bulk call campaigns through dedicated API routes built for high-volume outbound workflows.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI Lead Qualification",
    description: "Qualify prospects in natural voice conversations and move high-intent leads directly into your follow-up process.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Live Call Visibility",
    description: "Track call state, transcripts, and analysis endpoints so your team can react quickly when conversations need escalation.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Secure API Access",
    description: "JWT-based authentication, role-aware routes, and explicit CORS controls help keep your voice workflows protected.",
    visual: "security",
  },
];
...
function AIVisual() {
  const orbitPoints = [0, 1, 2, 3, 4, 5].map((i) => {
    const angle = (i * 60) * (Math.PI / 180);
    const radius = 50;
    return {
      i,
      x: Number((100 + Math.cos(angle) * radius).toFixed(6)),
      y: Number((80 + Math.sin(angle) * radius).toFixed(6)),
    };
  });
